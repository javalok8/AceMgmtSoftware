 ...
 * @author javalok
 */
public class Report_Import extends javax.swing.JInternalFrame {
    ...
    public void generateReport() {
        try {
            ...
            //Report format 
            ImportModel sellingModel = new ImportModel(conn);
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.createSheet("Product Import Report"); // you can add param as sheet also
            //create heading 
            ...
            if (jRadioButtonDaily.isSelected()) {
                ...
                if (jCheckBox1.isSelected()) {
                    ...
                    FileOutputStream out = new FileOutputStream(new File("d:\\ImportAllDailyReport.xls"));
                    workbook.write(out);
                    out.close();
                    workbook.close();
                } else {
                    ...
                    FileOutputStream out = new FileOutputStream(new File("d:\\ImportDailyIndividualReport.xls"));
                    workbook.write(out);
                    out.close();
                    workbook.close();
                }
                ...
                if (jCheckBox1.isSelected()) {
                    ...
                    FileOutputStream out = new FileOutputStream(new File("d:\\ImportAllMonthlyReport.xls"));
                    workbook.write(out);
                    out.close();
                    workbook.close();
                } else {
                    ...
                    FileOutputStream out = new FileOutputStream(new File("d:\\ImportMonthlyIndividualReport.xls"));
                    workbook.write(out);
                    out.close();
                    workbook.close();
                }
...
//            workbook.close();
     ...
     */
    public Report_Import(java.sql.Connection conn) {
        initComponents();
        this.conn = conn;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Import Report"));
